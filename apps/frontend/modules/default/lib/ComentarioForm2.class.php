...
class ComentarioForm2 extends BaseComentarioForm
{
  public function configure()
  {
      ...
      $this->setWidget('correo', new sfWidgetFormInputText(array(), array('size' =>40))); 
      $this->setWidget('telefono', new sfWidgetFormInputText(array(), array('size' =>40))); 
      $this->setWidget('nombre', new sfWidgetFormInputText(array(), array('size' =>40)));             //                       //ocultar campo de candidatoID
      $this->setWidget('idAnuncio', new sfWidgetFormInputHidden());   
      $this->setValidator('idAnuncio', new sfValidatorInteger());  
            
$this->setWidget('texto', new sfWidgetFormTextarea(array(),array('cols'=>40, 'rows'=>8))); 
