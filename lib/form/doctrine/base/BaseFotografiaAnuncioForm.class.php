...
/**
 * FotografiaAnuncio form base class.
 *
 * @method FotografiaAnuncio getObject() Returns the current form's model object
 *
 * @package    epi
 * @subpackage form
 * @author     Fabian Allel
 ...
 */
abstract class BaseFotografiaAnuncioForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fotografia_anuncio[%s]');
