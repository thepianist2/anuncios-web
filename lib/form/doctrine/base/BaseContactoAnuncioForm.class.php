...
/**
 * ContactoAnuncio form base class.
 *
 * @method ContactoAnuncio getObject() Returns the current form's model object
 *
 * @package    anuncios
 * @subpackage form
 * @author     Fabian Allel
 ...
 */
abstract class BaseContactoAnuncioForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('contacto_anuncio[%s]');
