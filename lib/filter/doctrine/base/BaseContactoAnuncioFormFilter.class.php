...
/**
 * ContactoAnuncio filter form base class.
 *
 * @package    anuncios
 * @subpackage filter
 * @author     Fabian Allel
 ...
 */
abstract class BaseContactoAnuncioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('contacto_anuncio_filters[%s]');
